...
- [CLI & REPL](getting-started/cli-repl.md)
...
- [Data Types](fundamentals/data-types/README.md)
  ...
  - [Booleans](fundamentals/data-types/booleans.md)
  ...
  - [Functions](fundamentals/data-types/functions.md)
  - [Regular Expressions](fundamentals/data-types/regex.md)
  - [Streams](fundamentals/data-types/streams.md)
  - [Nil](fundamentals/data-types/nil.md)
- [Operators](fundamentals/operators/README.md)
  - [Assignment](fundamentals/operators/assignment.md)
  - [Arithmetic](fundamentals/operators/arithmetic.md)
  - [Relational](fundamentals/operators/relational.md)
  - [Logical](fundamentals/operators/logical.md)
  - [Matching](fundamentals/operators/matching.md)
...
- [Random Numbers](stdlib/random.md)
- [Time and Dates](stdlib/time.md)
- [UUID](stdlib/uuid.md)
